...
//			insertData("student", "s"+i, "info", "sex", ""+x);
//			insertData("student", "s"+i, "course", "c"+i, "course"+i);
//			
//			insertData("course", "c"+i, "info", "tittle", "tittle"+i);
//			insertData("course", "c"+i, "info", "introduction", "intro"+i);
//			insertData("course", "c"+i, "info", "techear", "teacher"+i);
//			insertData("course", "c"+i, "info", "student", "student"+i);
//		}
		createTable("student", "info", "course");
		createTable("course", "info", "student");
